...
type PasswordResetHandler struct {
    ...
    pwService       *pwreset.Service
    emailService    *email.EmailService
    publicHost      string
}

func NewPasswordResetHandler(userSvc *userService.UserService, pwSvc *pwreset.Service, emailSvc *email.EmailService, publicHost string) *PasswordResetHandler {
